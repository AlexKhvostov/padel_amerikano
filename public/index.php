...
<body>
    <div id="app">
        ...
        <nav id="nav" class="bottom-nav hidden" aria-label="Основная навигация">
            ...
            <button data-action="logout-company" data-context="company" class="nav-btn">
            ...
            <button data-action="back-tournaments" data-context="tournament" class="nav-btn">
                <span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m15 18-6-6 6-6"/></svg></span>
                <span>Компания</span>
            </button>
            <button data-screen="rounds" data-context="tournament" class="nav-btn">
                <span class="nav-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="4" width="18" height="17" rx="3"/><path d="M8 2v4M16 2v4M3 10h18M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></svg></span>
                <span>Раунды</span>
            </button>
            <button data-screen="rating" data-context="tournament" class="nav-btn">
